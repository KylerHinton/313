...
echo "<td align='left'><b>Title: </td><td align='right'><input type = 'text' id = 'insMusicTitle' name = 'insMusicTitle'></td></tr>";
echo "<tr><td align='left'><b>Length: </td><td align='right'><input type = 'text' id='insMusicLength' name = 'insMusicLength'></td></tr>";
echo "<tr><td align='left'><b>In-game Location: </td><td align='right'><input type = 'text' id='insGameLoc' name = 'insGameLoc'></td></tr>";
